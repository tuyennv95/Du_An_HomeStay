...
export default function SignUp() {
    ...
    return (
        <div className={classes.sign_up}>
            ...
            <div className={classes.input_group}>
                ...
                <div style={{ display: 'flex', justifyContent: "space-between" }}>
                    <Autocomplete
                        ...
                        className={classes.input_phone_code_nation}
                        ...
                        // autoHighlight
                        getOptionLabel={(option) => countryToFlag(option.code) + ' +' + option.phone}
                        renderOption={(option) => (
                            <React.Fragment 
                            >
            ...
            {/* ----------------------------------------------------------
             */}
            <Button className={classes.button_sign_up}>
            Đăng Ký
            </Button>
            {/* ----------------------------------------------------------
             */}
            <Typography style={{textAlign:"center", paddingTop:'30px'}}>
                Bạn đã có tài khoản Luxstay? <Link href="#" color="secondary">Đăng nhập</Link>
            </Typography>
            {/* ----------------------------------------------------------
             */}
