                ...
                <Grid item md={6} xs={12} sm={12} className={classes.IntroAbout_text}>
                    ...
                    <Grid container spacing={1} style={{marginTop: '25px', width:'80%',margin:'auto'}}>
                        <Grid item md={8} xs={12} sm={12}>
                            <Link>
                                <img className={classes.intro_app_setup} src="https://www.luxstay.com/icons/apple-store.svg"></img>
                            </Link>
                           </Grid>
                        <Grid item md={4} xs={12} sm={12}>
                        <Link>
                                <img className={classes.intro_app_setup} src="https://www.luxstay.com/icons/google-play.svg"></img>
                            </Link>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item md={6} xs={12} sm={12} className={classes.IntroAbout_img}>
                    <img className={classes.intro_about_img_} src="https://www.luxstay.com/home/home-02.png"></img>
                </Grid>
            </Grid>
