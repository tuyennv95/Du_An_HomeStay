    ...
    return (
        <Box className={classes.footer_home}>
            ...
            <Box className={classes.footer_home_items}>
                        ...
                        <div style={{paddingTop:'25px'}}>
                            <img src="https://www.luxstay.com/icons/apple-store.svg" style={{width:'120px', hight:'35px'}}></img> <br/>
                            <img src="https://www.luxstay.com/icons/google-play.svg" style={{width:'120px', hight:'35px', paddingTop:'15px'}}></img>
                        </div> 
            </Box>
